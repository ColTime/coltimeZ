...
//Se valida que si se pueda ejecutar la consulta sin tener ningun problema
    ...
    private void editarColumnasProyecto() {
        ...
        TProyecto.getColumnModel().getColumn(3).setMinWidth(243);
        TProyecto.getColumnModel().getColumn(3).setMaxWidth(243);
        TProyecto.getTableHeader().getColumnModel().getColumn(3).setMaxWidth(243);
        TProyecto.getTableHeader().getColumnModel().getColumn(3).setMinWidth(243);
